...
public class Examples {
    ...
    public Examples() {
        ...
        Reading fin1 = new Reading(new Time(11, 0), 59.3, 9.1);
        Reading fin2 = new Reading(new Time(12, 11), 19.3, 3.1);
        fin= new LinkedList<>();
        fin.add(fin1);
        fin.add(fin2);
        w1=new WeatherStation(l1);
        w2=new WeatherStation(new DailyRepList(new LinkedList<TodaysWeatherReport>()));
        w3=new WeatherStation(new DailyRepList(new LinkedList<TodaysWeatherReport>()));
        w3.addTodaysReport(new GregorianCalendar(2021, 11, 11),fin);

    }
//        w1.addTodaysReport(new GregorianCalendar(2021, 10, 10), allr);
    @Test
    public void AvgmonthtempTest() {
        assertEquals(w1.averageMonthTemp(10, 2021), 51.73,.1);
    }
    @Test
    public void TotalMonthRainTest() {
        assertEquals(w1.totalMonthRainfall(10,2021), 37.5,0);
    }
    @Test
    public void AvgmonthtempTest0() {
        assertEquals(w2.averageMonthTemp(10, 2021), 0,0);
    }
    @Test
    public void TotalMonthRainTest0() {
        assertEquals(w2.totalMonthRainfall(10,2021), 0,0);
    }
    @Test
    public void AddWeatherReport() {
        assertEquals(w3.averageMonthTemp(11,2021),39.3,.1);
    }
